*** Settings ***
Library    SeleniumLibrary        # Library for web browser automation
...
# Credentials for logging in as Head
...
${REVIEW_LINK}          //a[@class='btn btn-sm btn-warning']                # XPath for review links
${NEWEST_REVIEW_LINK}   //a[contains(@class, 'btn btn-sm btn-warning')][1]  # XPath for the newest review link
${REVIEW_BUTTON}        //button[@id='btnReview']                           # XPath for the button to start the review
${REASON_FIELD}        //textarea[@class='swal2-textarea']                 # XPath for the text area to enter the rejection reason
${REJECT_BUTTON}      //button[@class='swal2-confirm swal2-styled']        # XPath for the rejection button

${REASON}    reject reason                                          # The reason for rejection

# Browser settings
${BROWSER}              Chrome                                              # Browser type for testing

*** Test Cases ***
# Test case to reject a working permit by Head
Working Permit Rejection By Head
    ...
    # Step 3: Perform the review action and reject the working permit
    ...
    Input Text    ${REASON_FIELD}    ${REASON}                 # Enters the rejection reason into the text area
